                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-example" class="hidden py-2 space-y-2">
                            ...
                            <li>
                                <a href="add-link" class="flex items-center w-full p-2 text-blue-700 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Tambah Link</a>
                            </li>
                        </ul>
                    </li>
                    <li>
    ...
    <div class="mt-14 p-4 sm:ml-64 bg-slate-100 h-screen">
        <div class="max-w-screen-xl mx-auto">
            <div class="mb-5 max-w-screen-xl bg-blue-600 px-5 py-8 rounded-lg">
                <h1 class="mb-1 text-4xl font-extrabold leading-none tracking-tight text-white md:text-2xl lg:text-3xl dark:text-white">Edit Link</h1>
                <p class="text-lg font-normal text-gray-50 lg:text-lg dark:text-gray-400">Edit Link Belajar Era Digital pada form dibawah ini</p>
            </div>
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <select id="category" name="category" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="text" required>
                        <option class="hidden" value="<?= $datas[0]['category'] ?>" selected><?= $datas[0]['category'] ?></option>
                ...
                <div class=" mb-6">
                    ...
                    <input type="text" name="link" id="link" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="<?= $datas[0]['link'] ?>" placeholder='Lengkap dengan "https://"' required />
                </div>
                <div class="mb-6">
                    <label for="icon" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload Icon</label>
                    <img class="my-2 max-h-24 aspect-square object-cover rounded-lg" src="../assets/img/<?= $datas[0]['icon'] ?>">
                    <input type="file" name="icon" id="icon" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" accept="image/*" />
                </div>
