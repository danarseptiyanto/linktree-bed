    ...
    <div class="mt-14 p-4 sm:ml-64 bg-slate-100 h-screen">
        <div class="max-w-screen-xl mx-auto">
            <div class="mb-5 max-w-screen-xl bg-blue-600 px-5 py-8 rounded-lg">
                <h1 class="mb-1 text-4xl font-extrabold leading-none tracking-tight text-white md:text-2xl lg:text-3xl dark:text-white">Tambah Link</h1>
                <p class="text-lg font-normal text-gray-50 lg:text-lg dark:text-gray-400">Tambah Link Belajar Era Digital pada form dibawah ini</p>
            </div>
